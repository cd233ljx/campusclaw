export type ThemeName = "claw" | "knot" | "dash" | "gdufe";
...
export const VALID_THEME_NAMES = new Set<ThemeName>(["claw", "knot", "dash", "gdufe"]);
...
export function resolveTheme(theme: ThemeName, mode: ThemeMode): ResolvedTheme {
  ...
  if (theme === "gdufe") {
    return resolvedMode === "light" ? "gdufe-light" : "gdufe";
  }
